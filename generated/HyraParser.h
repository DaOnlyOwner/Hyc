...
class  HyraParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleCompilationUnit = 0, RuleExpr = 1, RuleConstantExpr = 2, RuleStmt = 3, 
    RuleStmtList = 4, RuleAtomicStmt = 5, RuleDecStmt = 6, RuleBlockStmt = 7, 
    RuleIfStmt = 8, RuleSimpleBlockStmt = 9, RulePattern = 10, RuleLiteral = 11, 
    RuleIdentifier = 12
  };

  HyraParser(antlr4::TokenStream *input);
  ~HyraParser();
  ...
  class AtomicStmtContext;
  class DecStmtContext;
  ...
  public:
    ...
    HyraParser::PatternContext *lh = nullptr;
    HyraParser::ExprContext *rh = nullptr;
  ...
  public:
    ...
    HyraParser::ExprContext *lh = nullptr;
  ...
  class  BitwiseNegateExprContext : public ExprContext {
  public:
    BitwiseNegateExprContext(ExprContext *ctx);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    AtomicStmtContext *atomicStmt();
    DecStmtContext *decStmt();
  ...
  class  AtomicStmtContext : public antlr4::ParserRuleContext {
  public:
    AtomicStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExprContext *expr();
  ...
  class  DecStmtContext : public antlr4::ParserRuleContext {
  public:
    DecStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    PatternContext *pattern();
    ExprContext *expr();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DecIntegerLiteral();
